...
function isWholeUnitType(unit: string | null | undefined, packSize: string | null | undefined): boolean {
...
function isDecimalUnitType(unit: string | null | undefined): boolean {
  const u = (unit || "").toUpperCase().trim();
